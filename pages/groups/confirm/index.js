...
a.requirejs("foxui"), Page({
    ...
    onShow: function() {
        ...
        a.getCache("orderShop"), e && this.setData({
            "data.address": e,
            aid: e.id
        });
    },
    toggle: function(a) {
        var t = e.pdata(a), d = t.id, i = {};
        i[t.type] = 0 == d || void 0 === d ? 1 : 0, this.setData(i);
    },
    onHide: function() {},
    onUnload: function() {},
