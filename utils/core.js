...
module.exports = {
    ...
    getUrl: function(t, e, i) {
        t = t.replace(/\//gi, ".");
        var a = getApp().getConfig().api + "&r=" + t;
        return e && ("object" == (void 0 === e ? "undefined" : n(e)) ? a += "&" + o.param(e) : "string" == typeof e && (a += "&" + e)), 
        a;
    },
    json: function(t, e, n, i, a, r) {
        ...
        r || delete l.header.Cookie, a && (l.data = o.param(e)), n && (l.success = function(t) {
